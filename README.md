...
| --- | --- | --- | --- |
| CoC strong normalization | 6 | Accepted | [Submission.lean](generated/coc_strong_normalization/Submission.lean) and [supporting modules](generated/coc_strong_normalization/Submission) |
| Real-closed-field quantifier elimination | 4 | Accepted | [Submission.lean](generated/rcf_quantifier_elimination/Submission.lean) |
...
The two workspaces are under `generated/`. Each includes its benchmark statement, submitted proof, dependency lockfile, and Lean toolchain pin.
...
```sh
cd generated/coc_strong_normalization
lake exe cache get
lake build Submission Solution
```

For the RCF proof, use `generated/rcf_quantifier_elimination` instead.
